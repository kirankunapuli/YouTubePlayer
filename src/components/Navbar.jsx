    ...
    */
    ...
    return (
        <nav className="glass-panel navbar" style={{
            ...
            {/* Branding */}
            <div className="logo navbar-logo" style={{ fontSize: '1.4rem', fontWeight: 800, whiteSpace: 'nowrap' }}>
            ...
            {/* Right Toggles */}
            <div className="nav-actions navbar-actions" style={{ display: 'flex', gap: '0.5rem' }}>
                <button
